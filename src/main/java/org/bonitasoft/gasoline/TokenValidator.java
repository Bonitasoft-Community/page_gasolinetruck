...
public class TokenValidator {
     ...
     * Logger
     */
    private static final Logger LOGGER = Logger.getLogger("org.bonitasoft.custompage.org.bonitasoft.gasoline.TokenValidator");
    ...
    public static boolean checkCSRFToken(HttpServletRequest httpRequest, HttpServletResponse httpResponse) {
        ...
        String headerFromRequest = httpRequest.getHeader(CSRF_TOKEN_HEADER);
        Object apiToken = httpRequest.getSession().getAttribute(API_TOKEN_SESSION_ATTR);
        if (apiToken != null) {
